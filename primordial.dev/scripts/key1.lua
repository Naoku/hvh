    ...
    if keybind_enable:get() or entity_list.get_local_player() then 
        ...
        for i, v in pairs(keybindings) do
            ...
            if dap:get() or menu.is_open() then
                ...
                render.rect_filled(vec2_t(keybindlist_position.x+165-itssize.x, keybindlist_positiony2+offset*18+offset*1), vec2_t(itssize.x+20, itssize.y+2), color_t(13,13,13,110),3)
                ...
                render.rect_filled(vec2_t(keybindlist_position.x-10, keybindlist_positiony2+offset*18+offset*1), vec2_t(functiontext.x+20, functiontext.y+2), color_t(13,13,13,110),3)
